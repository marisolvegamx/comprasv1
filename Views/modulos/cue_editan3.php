<?php 
 ...
 // var_dump($nivel);
  ...
  <section class="content container-fluid">
   ...
   <form role="form" method="post" action="index.php?action=listan3&admin=act&niv=3">
      <?php     
          $op="";
          ...
          <div class="form-group col-md-12">
             <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $nivel["n3_id"]; ?>">
               ...
               <label>CLIENTE</label>
                 ...
                 <?php     
                  ...
                  $RS_SQM_TE =Datosndos::vistandosByn1($nivel["n3_idn1"], "ca_nivel2");
               //  var_dump($RS_SQM_TE);
           foreach ($RS_SQM_TE as $registro) {
