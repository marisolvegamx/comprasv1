...
<body>
    <table border="1px"  bordercolor="#9d981c" width="100%">
        ...
        <tr>
          <td style="width: 10%; font-size: 10px; text-align: right; background: #f6f296;">RECOLECTOR :</td>   
 
          <td style="width: 22% ; font-size: 10px; padding-left: 5px; background: #f8f6b9;"> <?php echo  $informeCont->getrecolector(); ?>
  ...
  ?>
        ...
        <tr>
          <td style="background: #f8f6b9; ">
           <table border="2px"  bordercolor="#dbd66d" lang="100%" height="10px">  
...
<tr>
        ...
        <td style=" background: #9d981c; border-color: #ffffff; font-size: 12px; text-align: center; " colspan="4">
          ...
          <td style="background: #f8f6b9; ">
           ...
           <table border="2px"  bordercolor="#dbd66d" width="100%" lang="100%" height="10px">  
             <tr>  
