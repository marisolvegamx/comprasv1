             ...
             <div class="box-body">
                ...
                <!-- Datos iniciales alta de punto de venta -->
                    <div class="form-group col-md-12">
                      <label>NOMBRE</label>
                      <input type="text" class="form-control" placeholder="NOMBRE COMPLETO" name="nomrec" id="nomrec" required>
                      </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-3">
                    <label>PEPSI</label>
                       <input type="checkbox"  class="form-control" name="chkpepsi" value="si" >
                  </div>

                  <div class="col-3">
                    <label>PEÑAFIEL</label>
                      <input type="checkbox"  class="form-control" name="chkpenaf" value="si">
                  </div>

                  <div class="col-3">
                    <label>ELECTROPURA</label>
                    <input type="checkbox" class="form-control" name="chkelectro" value="si" >
                  </div>
