        ...
        echo '<div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  ...
                  <th style="width: 25%">NOMBRE DEL RECOLECTOR</th>
                  <th style="width: 25g%">PAIS</th>
                  <th style="width: 25%">CORREO ELECTRONICO</th>
			...
			foreach($respuesta as $row => $item){
					$nump= $item["rec_pais"];
				$rs = DatosCatalogoDetalle::getCatalogoDetalle("ca_catalogosdetalle",10,$nump);
           echo
            '  <tr>
	               <td>'.$item[0].'</td>
  ...
  $respuesta = DatosRecolector::vistarecolectorDetalle($nrec, "ca_recolectores");
   echo '
	<div class="form-group col-md-12">
      ...
      <input type="text" class="form-control" placeholder="DIRECCION" name="dircasa" id="desuneg" value="'.$respuesta["rec_direccion"].'" required>
      </div>

      <div class="form-group col-md-12">
      <label>DIRECCION DE ENVIO DE ETIQUETAS</label>
      <input type="text" class="form-control" placeholder="DIRECCION 2" name="direti" id="desuneg" value="'.$respuesta["rec_direccion_eti"].'" required>
      </div>
