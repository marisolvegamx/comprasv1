...
LIKE :opbusqueda ";
    ...
    public function UnegocioCompleta($iduneg, $tabla) {
        ...
        $stmt = Conexion::conectar()->prepare("SELECT une_descripcion, une_direccion, une_dir_cp, une_dir_referencia, une_cla_pais, une_cla_ciudad, une_estatus, une_coordenadasxy, une_puntocardinal, une_tipotienda, une_cadenacomercial FROM ca_unegocios WHERE une_id=:iduneg;");
