...
class DatosRecolector extends Conexion{
    ...
    public function insertarRec($datosModel,$tabla){
              ...
              $sSQL= "INSERT INTO $tabla(rec_nombre, rec_tipo, rec_pais, rec_direccion, rec_direccion_eti, rec_celular, rec_telefono_casa, rec_telefono_trabajo, rec_telefono_familia, rec_email_personal, rec_email_oficina, rec_tarjeta) VALUES (:nomrec,:tiporec, :paisrec, :dircasa, :direti, :numcel, :telcasa, :telofi, :telfam, :emailper, :emailtrab,:numtarjeta);";
    ...
    public function vistarecolectorDetalle($nrec, $tabla) {
        ...
        $stmt = Conexion::conectar()->prepare("SELECT rec_nombre, rec_pais, rec_tarjeta, rec_telefono_casa, rec_telefono_familia, rec_telefono_trabajo, rec_tipo, rec_celular, rec_email_oficina, rec_email_personal, rec_direccion, rec_direccion_eti FROM ca_recolectores WHERE rec_id=:nrec");
     ...
     public function actualizaRec($datosModel,$tabla){
            //try{      
              ...
              $sSQL= "UPDATE ca_recolectores SET rec_nombre=:nomrec,rec_pais=:paisrec,rec_tarjeta=:numtarjeta,rec_telefono_casa=:telcasa,rec_telefono_familia=:telfam,rec_telefono_trabajo=:telofi,rec_tipo=:tiporec,rec_celular=:numcel,rec_email_oficina=:emailtrab,rec_email_personal=:emailper,rec_direccion=:dircasa,rec_direccion_eti=:direti WHERE rec_id=:idrec
              ";
