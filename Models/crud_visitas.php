...
( vi_idlocal, vi_indice,vi_geolocalizacion, vi_tiendaid, vi_fotofachada, vi_estatus, vi_cverecolector, vi_createdat, vi_updatedat)
VALUES( :vi_idlocal, :vi_indice,:vi_geolocalizacion, :vi_tiendaid, :vi_fotofachada, :vi_estatus, :vi_cverecolector, :vi_createdat, :vi_updatedat);";
    ...
    public static function actualizar($datosModel,$idtienda,$tabla){
        try{
...
WHERE vi_idlocal=idlocal;";
            ...
            $stmt->bindParam(":fupdates", $datosModel[ContratoVisitas::UPDATEDAT], PDO::PARAM_STR);
            
            if(!$stmt-> execute())
                throw new Exception("Hubo un error al actualizar ".$stmt->errorInfo());
                //echo $stmt->debugDumpParams();
